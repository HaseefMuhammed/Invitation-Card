function showWelcome() {
    ...
    document.getElementById('welcomeModalLabel').innerHTML = 'Welcome, ' + name + '! We are excited to have you at our Engagment.';
...
function music() {
    ...
    setTimeout(function() {
        audio = new Audio('images/song invitation by Haseef.mp3'); // Replace with the path to your music file
        audio.loop = true; // Set the loop property to true
        audio.play(); // Start playing the music
    }, 100);
}
